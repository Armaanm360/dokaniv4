                    	...
                    	<div class="tabs-content">
                    		...
                    		<div id="login-tab-content" class="active">
                    			<form class="login-form" action="{{ route('login') }}" method="post">
                                            @csrf
                                            <input type="text" class="input" @error('email') is-invalid @enderror id="user_login" autocomplete="off" name="email" placeholder="Your Email" value="armaan@gmail.com">
                                              @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                @enderror
                                            <input type="password" class="input" id="user_pass" autocomplete="off" name="password" placeholder="Password" value="12345678">
                    				  @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
