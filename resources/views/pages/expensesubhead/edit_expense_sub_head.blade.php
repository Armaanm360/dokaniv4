                ...
                <div class="col-6">
                    <div class="card">
                        <div class="card-header">
                            <h6 class="card-title mb-0">Edit Expense Head</h6>
                        </div>
                        <div class="card-body">
                            <form class="row g-3 maskking-form" id="expense_head">
                                ...
                                @method('PUT')
                                <div class="col-8">
                                    <span class="float-label mb-4">
                                        <input type="text" class="form-control form-control-lg" name="expense_head_id"
                                            value="{{ getExpenseHead($head->expense_head_id) }}" readonly>
                                    ...
                                    <span class="float-label">
                                        <input type="text" class="form-control form-control-lg" id="expense_head"
                                            name="title" value="{{ $head->subtitle }}">

                                        <input type="hidden" class="form-control form-control-lg" id="expense_head_id"
                                            name="expense_sub_head_id" value="{{ $head->expense_sub_head_id }}">
    ...
    <script type="text/javascript">
        $("#expense_head").submit(function(e) {
            ...
            $.ajax({
                ...
                method: "POST",
                url: "{{ url('expense-sub-head') }}/" + $('#expense_head_id').val(),
                data: data,
                cache: false,
                contentType: false,
                processData: false,
