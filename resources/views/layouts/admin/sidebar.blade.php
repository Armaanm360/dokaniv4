      ...
      <div class="container-fluid">
          ...
          <div class="main-menu flex-grow-1">
              <ul class="menu-list">
                  ...
                  @if ($user->can('add-account'))
                      <li class="collapsed">
                          <a class="m-link" data-bs-toggle="collapse" data-bs-target="#menu-Products"
                              href="#">
                              <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="currentColor"
                                  viewBox="0 0 16 16">
                                  <path fill-rule="evenodd" clip-rule="evenodd"
                  ...
                  <li class="collapsed">
                      ...
                      <ul class="sub-menu collapse" id="menu-Suppliers">
                          ...
                          <li><a class="ms-link" href="{{ url('supplier-payment') }}">Supplier Payment</a></li>
